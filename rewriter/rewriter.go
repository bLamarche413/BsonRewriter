// This file is a fork of tsuna's gorewrite. It traverses the tree bottom up instead of top down.
// This is necessary for the Rewriting to work correctly.
package rewriter
...
func rewriteExprList(v Rewriter, list []Expr) {
	//fmt.Println("in rewrite Expr List")
	for i, x := range list {
